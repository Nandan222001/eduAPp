...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('currency', sa.String(length=3), nullable=False, server_default='INR'),
        sa.Column('billing_period_start', sa.DateTime(timezone=False), nullable=False),
        sa.Column('billing_period_end', sa.DateTime(timezone=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('recorded_at', sa.DateTime(timezone=False), nullable=False, server_default=sa.text('CURRENT_TIMESTAMP')),
