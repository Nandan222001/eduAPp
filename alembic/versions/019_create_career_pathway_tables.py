...
def upgrade():
    op.create_table(
        ...
        sa.Column('optional_education', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('typical_courses', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('certifications', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('extracurricular_activities', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('work_environment', sa.Text(), nullable=True),
        sa.Column('typical_tasks', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('career_progression', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('related_careers', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('personality_assessment_data', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('current_skills', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('skill_proficiency', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('preferred_work_environment', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('academic_performance_summary', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('top_subjects', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('extracurricular_activities', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('volunteer_experience', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('geographic_preferences', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('salary_expectations', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('matching_factors', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('career_pathway_id', sa.Integer(), nullable=False),
        sa.Column('required_skills', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        sa.Column('current_skills', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        sa.Column('skill_gaps', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        ...
        sa.Column('priority_skills', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('foundational_skills', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('advanced_skills', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('recommended_actions', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('learning_resources', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('recommended_courses', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        sa.Column('recommended_certifications', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('recommended_extracurriculars', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('in_progress_items', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('top_skills_demand', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('emerging_skills', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('geographic_data', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('industry_trends', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('expertise_areas', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        sa.Column('career_path', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('preferred_communication', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('mentoring_style', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('match_score', sa.Numeric(precision=5, scale=2), nullable=False),
        sa.Column('matching_criteria', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('progress_notes', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('student_feedback', sa.Text(), nullable=True),
