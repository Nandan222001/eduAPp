...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('anonymization_config', sa.JSON(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('generated_at', sa.DateTime(), nullable=False, server_default=sa.text('CURRENT_TIMESTAMP'), index=True),
