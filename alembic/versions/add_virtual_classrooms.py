...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('scheduled', 'live', 'ended', 'cancelled', name='classroomstatus'), nullable=False),
        ...
        sa.Column('whiteboard_data', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('role', postgresql.ENUM('host', 'moderator', 'participant', 'observer', name='participantrole'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('idle', 'recording', 'processing', 'completed', 'failed', name='recordingstatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('active', 'closed', name='breakoutroomstatus'), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('draft', 'active', 'ended', name='pollstatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('selected_options', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('draft', 'active', 'ended', name='quizstatus'), nullable=False),
