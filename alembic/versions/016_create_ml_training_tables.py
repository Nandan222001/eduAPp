...
def upgrade():
    ...
    if 'ml_models' not in inspector.get_table_names() or 'ml_model_versions' not in inspector.get_table_names():
        return
    ...
    if 'ml_training_jobs' not in inspector.get_table_names():
        op.create_table(
            'ml_training_jobs',
    ...
    if 'model_performance_metrics' not in inspector.get_table_names():
        op.create_table(
    ...
    if 'model_promotion_logs' not in inspector.get_table_names():
        op.create_table(
...
def downgrade():
    ...
    if 'model_promotion_logs' in inspector.get_table_names():
    ...
    if 'model_performance_metrics' in inspector.get_table_names():
