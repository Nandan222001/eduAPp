...
def upgrade():
    op.create_table(
        ...
        sa.Column('calendar_sync_enabled', sa.Boolean(), nullable=False, server_default=sa.text('0')),
        sa.Column('calendar_sync_url', sa.String(length=500), nullable=True),
        sa.Column('adaptive_rescheduling_enabled', sa.Boolean(), nullable=False, server_default=sa.text('1')),
