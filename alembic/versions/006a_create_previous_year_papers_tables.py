...
def upgrade():
    op.create_table('previous_year_papers',
        ...
        sa.Column('board', sa.Enum('cbse', 'icse', 'state_board', 'ib', 'cambridge', 'other', native_enum=False), nullable=False),
    ...
    op.create_table('questions_bank',
        ...
        sa.Column('question_type', sa.Enum('multiple_choice', 'short_answer', 'long_answer', 'true_false', 'fill_in_blank', 'numerical', 'match_the_following', 'assertion_reasoning', native_enum=False), nullable=False),
        sa.Column('grade_id', sa.Integer(), nullable=False),
        sa.Column('subject_id', sa.Integer(), nullable=False),
        sa.Column('chapter_id', sa.Integer(), nullable=True),
        sa.Column('topic_id', sa.Integer(), nullable=True),
        sa.Column('difficulty_level', sa.Enum('very_easy', 'easy', 'medium', 'hard', 'very_hard', native_enum=False), nullable=False),
        sa.Column('bloom_taxonomy_level', sa.Enum('remember', 'understand', 'apply', 'analyze', 'evaluate', 'create', native_enum=False), nullable=False),
