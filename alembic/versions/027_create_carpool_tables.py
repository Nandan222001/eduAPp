...
down_revision = '026_create_fee_management_tables'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('pickup_points', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        sa.Column('rotation_schedule', postgresql.JSON(astext_type=sa.Text()), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('student_ids', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        sa.Column('route', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        sa.Column('schedule_days', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        ...
        sa.Column('matching_criteria', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        sa.Column('status', sa.String(length=20), nullable=False, server_default='active'),
    ...
    op.create_table(
        ...
        sa.Column('pickup_sequence', postgresql.JSON(astext_type=sa.Text()), nullable=False),
        ...
        sa.Column('confirmations', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('vehicle_info', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('notes', sa.Text(), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.text('now()')),
        sa.Column('updated_at', sa.DateTime(), nullable=False, server_default=sa.text('now()')),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table(
        ...
        sa.Column('notified_parents', postgresql.JSON(astext_type=sa.Text()), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('match_details', postgresql.JSON(astext_type=sa.Text()), nullable=False),
