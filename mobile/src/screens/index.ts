...
export { DashboardScreen as StudentDashboardScreen } from './student/DashboardScreen';
export { CoursesScreen } from './student/CoursesScreen';
export { CourseDetailScreen } from './student/CourseDetailScreen';
export { AssignmentsScreen } from './student/AssignmentsScreen';
...
export { ChildDetailScreen } from './parent/ChildDetailScreen';
export { GradesScreen as ParentGradesScreen } from './parent/GradesScreen';
