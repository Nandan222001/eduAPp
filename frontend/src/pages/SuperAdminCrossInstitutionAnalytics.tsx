...
export default function SuperAdminCrossInstitutionAnalytics() {
  ...
  const [analyticsData, setAnalyticsData] = useState<CrossInstitutionAnalyticsResponse | null>(
    null
  );
  ...
  return (
    <Box sx={{ p: 3 }}>
            ...
            <Table>
              ...
              <TableBody>
                {rankings.slice(0, 20).map((ranking) => {
                  const institution = institution_metrics.find(
                    (m) => m.institution_id === ranking.institution_id
                  );
                  return (
                ...
                <CardContent>
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={trends.monthly_trends}>
                      ...
                      <Line
                        type="monotone"
                        dataKey="average_exam_pass_rate"
            ...
            <Grid item xs={12} md={4}>
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography
                    variant="h4"
                    color={trends.attendance_trend_percentage >= 0 ? 'success.main' : 'error.main'}
                  >
                    {trends.attendance_trend_percentage > 0 ? '+' : ''}
                    {trends.attendance_trend_percentage.toFixed(1)}%
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
              ...
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography
                    variant="h4"
                    color={
                      trends.exam_performance_trend_percentage >= 0 ? 'success.main' : 'error.main'
                    }
                  >
                    {trends.exam_performance_trend_percentage > 0 ? '+' : ''}
                    {trends.exam_performance_trend_percentage.toFixed(1)}%
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            <Grid item xs={12} md={4}>
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography
                    variant="h4"
                    color={trends.engagement_trend_percentage >= 0 ? 'success.main' : 'error.main'}
                  >
                    {trends.engagement_trend_percentage > 0 ? '+' : ''}
                    {trends.engagement_trend_percentage.toFixed(1)}%
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
                ...
                <Grid item xs={12} md={6} key={index}>
                  ...
                  >
                    ...
                    <Typography variant="caption" display="block" mt={1}>
                      Expected: {anomaly.expected_value.toFixed(1)} | Actual:{' '}
              ...
              <Grid item xs={12} md={6} key={index}>
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Typography variant="body2">{practice.recommendation}</Typography>
                    <Box mt={2}>
                      <Typography variant="caption" color="text.secondary">
      ...
      <Dialog
        ...
        fullWidth
      >
        <DialogTitle>{selectedInstitution?.institution_name}</DialogTitle>
        <DialogContent>
          {selectedInstitution && (
            <Grid container spacing={2} sx={{ mt: 1 }}>
              ...
              <Grid item xs={6} sm={3}>
                ...
                <Typography
                  ...
                  color={getMetricColor(
                    selectedInstitution.average_attendance,
                    benchmarks.average_attendance
                  )}
                >
              ...
              <Grid item xs={6} sm={3}>
                ...
                <Typography
                  variant="h6"
                  color={getMetricColor(
                    selectedInstitution.exam_pass_rate,
                    benchmarks.average_exam_pass_rate
                  )}
                >
              ...
              <Grid item xs={6} sm={3}>
                ...
                <Typography
                  variant="h6"
                  color={getMetricColor(
                    selectedInstitution.student_engagement_score,
                    benchmarks.average_engagement_score
                  )}
                >
              ...
              <Grid item xs={6} sm={3}>
                ...
                <Typography
                  variant="h6"
                  color={getMetricColor(
                    selectedInstitution.teacher_effectiveness_score,
                    benchmarks.average_teacher_effectiveness
                  )}
                >
