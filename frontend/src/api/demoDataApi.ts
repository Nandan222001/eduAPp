...
export const demoInstitutionAdminApi = {
  ...
  getSubscriptionBilling: async () => {
    ...
    return Promise.resolve({
      subscription: {
        ...
        canceled_at: null,
        next_billing_date: nextBillingDate.toISOString().split('T')[0] + 'T00:00:00Z',
        auto_renew: true,
        external_subscription_id: 'sub_demo_123',
      ...
      invoices: [
        {
          ...
          invoice_url: 'https://example.com/invoices/inv-2024-002.pdf',
          metadata: null,
        ...
        },
        {
          ...
          paid_at: '2024-01-15T09:45:00Z',
          invoice_url: 'https://example.com/invoices/inv-2024-001.pdf',
          metadata: null,
        ...
        },
        {
          ...
          total_amount: 2500,
          currency: 'USD',
          billing_period_start: '2023-12-01T00:00:00Z',
          billing_period_end: '2023-12-31T23:59:59Z',
          due_date: '2023-12-15T00:00:00Z',
          paid_at: '2023-12-15T11:20:00Z',
          invoice_url: 'https://example.com/invoices/inv-2023-012.pdf',
          metadata: null,
        ...
        },
        {
          ...
          paid_at: '2023-11-15T10:15:00Z',
          invoice_url: 'https://example.com/invoices/inv-2023-011.pdf',
          metadata: null,
          created_at: '2023-11-01T00:00:00Z',
          updated_at: '2023-11-15T10:15:00Z',
        },
        {
          id: 5,
          subscription_id: 1,
          ...
          paid_at: '2023-10-15T09:30:00Z',
          invoice_url: 'https://example.com/invoices/inv-2023-010.pdf',
          metadata: null,
      ...
      addOns: [
        {
          ...
          monthly_price: 99,
          yearly_price: 990,
          features: ['Unlimited SMS', 'Automated alerts', 'Custom templates'],
        },
        {
          id: 2,
          ...
          monthly_price: 199,
          yearly_price: 1990,
          features: ['Custom dashboards', 'Exportable reports', 'Data visualization'],
        },
        {
          id: 3,
          name: 'Parent Mobile App',
          description: 'Dedicated mobile app for parent engagement',
          monthly_price: 149,
          yearly_price: 1490,
          features: ['iOS & Android apps', 'Real-time updates', 'Push notifications'],
        },
      ],
      activeAddOns: [1, 3],
      usage: {
      ...
      history: [
        ...
        },
        {
          ...
          description: 'Auto-renewal processed for monthly billing',
  ...
  getInstitutionAnalytics: async (params?: { start_date?: string; end_date?: string }) => {
    return Promise.resolve({
      institution_id: 1,
      institution_name: 'Demo Institution',
      period_start: params?.start_date || '2024-01-01',
      period_end: params?.end_date || new Date().toISOString(),
      grade_comparisons: [
        {
          grade: '6th Grade',
          totalStudents: 180,
